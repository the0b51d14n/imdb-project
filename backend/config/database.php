...
function db(): PDO
{
    ...
    // PHP 8.5 déprécie PDO::MYSQL_ATTR_INIT_COMMAND au profit de
    // Pdo\Mysql::ATTR_INIT_COMMAND. On prend la constante exposée par le
    // runtime : la notice émise sinon casserait l'envoi du cookie de session.
