<?php
/**
 * frontend/partials/auth-buttons.php
 * Boutons connexion / déconnexion réutilisables (navbar, etc.)
 * Requiert que $basePath soit défini.
 */
if (!isset($basePath)) {
...
<?php if (!empty($_SESSION['user_id'])): ?>
  ...
  <button class="logout-btn-animated"
